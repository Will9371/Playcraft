...
namespace ZMD
{
    public interface IAddForce { void AddForce(Vector3 force, ForceMode mode = ForceMode.Force, float duration = 0f); }
    ...
    public class RBInterface : MonoBehaviour, IAddForce
    {
        ...
        public void AddForce(Vector3 force, ForceMode mode = ForceMode.Force, float duration = 0f)
