...
namespace ZMD.PredictiveMovement
{
    public class ThiefCursor : MonoBehaviour
    {
        ...
        public string successText = "Successfully hit target!";
        public string failText = "Oh no, you've been caught!";
        ...
        void Caught()
        {
            ...
            text.DisplayForTime(failText, displayTextTime);
        }
        ...
        {
            if (recentlyCaught) return;
            text.DisplayForTime(successText, displayTextTime);
        }
    }
}
