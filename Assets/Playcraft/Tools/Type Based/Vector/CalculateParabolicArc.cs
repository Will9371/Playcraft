...
public class CalculateParabolicArc : MonoBehaviour
{
    ...
    float angle { get { return -source.localEulerAngles.x; } }
    float radianAngle { get { return Mathf.Deg2Rad * angle; } }
    Vector3 forward { get { return new Vector3(0f, source.eulerAngles.y, 0f); } }
